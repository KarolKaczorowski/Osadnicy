...
if (isset($_POST['email'])) {
    ...
    //tylko znaki A-Z a-z i numeryczne
    ...
    //echo $haslo_hash; exit(); wyswietlanie shashowanego hasla
    ...
    //Bot or not?
    $sekret = "6LfOKywUAAAAAA2AIPumFwpzcsegL1hmVtvBqUUt";
    ...
    //zapamietaj wprowadzone dane w formularzu
    ...
    try {
        ...
        echo'<div class="alert alert-danger">Błąd serwera! Przepraszamy za niedogodności i prosimy o rejestrację w innym terminie.</div>';
                    ...
                    <form method="post">
                        ...
                        ?>" name="haslo1"><br>
                                          ...
                                          if (isset($_SESSION['e_haslo'])) {
                                              echo '<div class="alert alert-danger">' . $_SESSION['e_haslo'] . '</div>';
                        ...
                        if (isset($_SESSION['e_regulamin'])) {
                            echo '<div class="alert alert-danger">' . $_SESSION['e_regulamin'] . '</div>';
                            unset($_SESSION['e_regulamin']);
                        }
                        ?>
                        <div class="g-recaptcha" data-sitekey="6LfOKywUAAAAAIuPNEq3W-G0xzi31GXzIcHI7bFS"></div>
                        <?php
